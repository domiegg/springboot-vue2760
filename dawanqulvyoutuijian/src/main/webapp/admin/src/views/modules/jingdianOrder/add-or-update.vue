    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="jingdianId" name="jingdianId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预定人数" prop="jingdianOrderNumber">
                       <el-input v-model="ruleForm.jingdianOrderNumber"
                                 placeholder="预定人数" clearable  :readonly="ro.jingdianOrderNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="预定人数" prop="jingdianOrderNumber">
                           <el-input v-model="ruleForm.jingdianOrderNumber"
